    ...
    <div className="flex flex-col">
      <section className="relative w-full py-20 md:py-32 bg-secondary/50">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-lg md:text-xl text-foreground/80 font-semibold">
            Fast - Fresh - Instant
          </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {categories.map((category) => (
              <Card key={category.name} className="text-center transform hover:-translate-y-2 transition-transform duration-300 ease-in-out shadow-lg hover:shadow-xl">
                <CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial) => (
              <Card key={testimonial.name} className="flex flex-col justify-center items-center text-center p-6">
                 <Image src={testimonial.avatar} alt={testimonial.name} width={80} height={80} className="rounded-full mb-4" data-ai-hint="person" />
                <CardContent>
